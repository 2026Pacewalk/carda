            ...
            <table className="w-full text-left">
              <thead>
                <tr className="border-b border-gray-100 bg-[#f8f7f7]">
                  ...
                  <th className="text-[10px] font-bold text-[#888] uppercase px-4 py-3">Business</th>
                  <th className="text-[10px] font-bold text-[#888] uppercase px-4 py-3">Owner</th>
                  ...
                  <th className="text-[10px] font-bold text-[#888] uppercase px-4 py-3">Downloads</th>
              ...
              <tbody>
                {cards.map((c: any) => (
                  <tr key={c.id} className="border-b border-gray-50 hover:bg-[#f8f7f7]">
                    ...
                    <td className="px-4 py-3"><span className={`px-2 py-0.5 rounded-full text-[9px] font-bold ${c.status === "published" ? "bg-green-100 text-green-700" : "bg-yellow-100 text-yellow-700"}`}>{c.status}</span></td>
